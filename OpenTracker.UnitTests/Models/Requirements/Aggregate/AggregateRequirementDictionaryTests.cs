...
{
    public class AggregateRequirementDictionaryTests
    {
        ...
        {
            IAggregateRequirement Factory(IList<IRequirement> requirements)
            {
                return Substitute.For<IAggregateRequirement>();
            }
        ...
        public void AutofacTest()
        {
            ...
            var sut = scope.Resolve<IAggregateRequirementDictionary>();
            
            Assert.NotNull(sut as AggregateRequirementDictionary);
        }
    }
}