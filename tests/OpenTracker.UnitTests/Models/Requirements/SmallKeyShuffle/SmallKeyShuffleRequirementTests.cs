...
public sealed class SmallKeyShuffleRequirementTests
{
    private readonly IMode _mode = Substitute.For<IMode>();
    
    private void ChangeSmallKeyShuffle(bool newValue)
    {
        _mode.SmallKeyShuffle.Returns(newValue);
        _mode.PropertyChanged += Raise
            .Event<PropertyChangedEventHandler>(
                _mode,
                new PropertyChangedEventArgs(nameof(IMode.SmallKeyShuffle)));
    }
    ...
    public void Met_ShouldReturnExpectedValue(bool expected, bool smallKeyShuffle, bool requirement)
    {
        ...
        ChangeSmallKeyShuffle(smallKeyShuffle);
    ...
    public void AutofacResolve_ShouldResolveToTransientInstance()
    {
        ...
        var factory = scope.Resolve<SmallKeyShuffleRequirement.Factory>();
