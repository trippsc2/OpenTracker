...
public sealed class KeyDropShuffleRequirementTests
{
    ...
    private void ChangeKeyDropShuffle(bool newValue)
    {
        _mode.KeyDropShuffle.Returns(newValue);
        _mode.PropertyChanged += Raise
            .Event<PropertyChangedEventHandler>(
                _mode,
                new PropertyChangedEventArgs(nameof(IMode.KeyDropShuffle)));
    }
    ...
    public void Met_ShouldReturnExpectedValue(bool expected, bool keyDropShuffle, bool requirement)
    {
        ...
        ChangeKeyDropShuffle(keyDropShuffle);
    ...
    public void AutofacResolve_ShouldResolveToTransientInstance()
    {
        ...
        var factory = scope.Resolve<KeyDropShuffleRequirement.Factory>();
