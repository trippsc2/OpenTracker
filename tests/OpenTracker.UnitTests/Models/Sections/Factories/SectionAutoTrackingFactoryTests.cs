...
{
    private static readonly IAutoTracker AutoTracker = Substitute.For<IAutoTracker>();
    ...
    private static readonly IBigKeyShuffleRequirementDictionary BigKeyShuffleRequirements =
        new BigKeyShuffleRequirementDictionary(expectedValue =>
            new BigKeyShuffleRequirement(Mode, expectedValue));
    private static readonly ICompassShuffleRequirementDictionary CompassShuffleRequirements =
        new CompassShuffleRequirementDictionary(expectedValue =>
            new CompassShuffleRequirement(Mode, expectedValue));
    private static readonly IMapShuffleRequirementDictionary MapShuffleRequirements =
        new MapShuffleRequirementDictionary(expectedValue => new MapShuffleRequirement(Mode, expectedValue));
    private static readonly RaceIllegalTrackingRequirement RaceIllegalTrackingRequirement = new(AutoTracker);
    private static readonly ISmallKeyShuffleRequirementDictionary SmallKeyShuffleRequirements =
        new SmallKeyShuffleRequirementDictionary(expectedValue =>
            new SmallKeyShuffleRequirement(Mode, expectedValue));
