...
public sealed class ShopSectionFactoryTests
{
    ...
    private static readonly IShopShuffleRequirementDictionary ShopShuffleRequirements =
        new ShopShuffleRequirementDictionary(expectedValue =>
            new ShopShuffleRequirement(Mode, expectedValue));
    private static readonly ITakeAnyLocationsRequirementDictionary TakeAnyLocationsRequirements =
        new TakeAnyLocationsRequirementDictionary(expectedValue => 
            new TakeAnyLocationsRequirement(Mode, expectedValue));
