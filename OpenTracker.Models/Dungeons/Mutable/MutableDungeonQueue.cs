...
namespace OpenTracker.Models.Dungeons.Mutable
{
    ...
    public class MutableDungeonQueue : ConcurrentQueue<IMutableDungeon>, IMutableDungeonQueue
    {
        ...
        /// </param>
        /// <param name="count">
        /// A nullable 32-bit signed integer representing the number of instances to create.  This defaults to one less
        /// than the current processor count with a maximum of 1.
        /// </param>
