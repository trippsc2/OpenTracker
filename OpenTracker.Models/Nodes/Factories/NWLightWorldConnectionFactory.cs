...
{
    /// <summary>
    ///     This class contains the creation logic for northwest light world node connections. 
    /// </summary>
    public class NWLightWorldConnectionFactory : INWLightWorldConnectionFactory
    {
