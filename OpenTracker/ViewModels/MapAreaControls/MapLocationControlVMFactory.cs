...
namespace OpenTracker.ViewModels.MapAreaControls
{
    ...
    /// </summary>
    internal static class MapLocationControlVMFactory
    {
        /// <summary>
        ...
        /// </returns>
        private static ObservableCollection<MarkingSelectControlVM> GetMarkingSelectControlVMs(
        ...
        /// </returns>
        private static MarkingMapLocationControlVM GetMapLocationMarkingControlVM(IMarkableSection section)
        {
            return new MarkingMapLocationControlVM(
        ...
        /// </returns>
        private static MapLocationControlVMBase GetEntranceMapLocationControlVM(
            ...
            ObservableCollection<PinnedLocationControlVM> pinnedLocations)
        {
            ...
            return new EntranceMapLocationControlVM(
        ...
        /// </returns>
        private static MapLocationControlVMBase GetMarkableMapLocationControlVM(
            MapLocation mapLocation, MapAreaControlVM mapArea,
            ObservableCollection<PinnedLocationControlVM> pinnedLocations)
        {
            if (mapLocation == null)
            ...
            return new MarkableMapLocationControlVM(
        ...
        /// </returns>
        public static MapLocationControlVMBase GetMapLocationControlVM(
            MapLocation mapLocation, MapAreaControlVM mapArea,
            ObservableCollection<PinnedLocationControlVM> pinnedLocations)
        {
            if (mapLocation == null)
            ...
            switch (mapLocation.Location.Sections[0])
            {
                ...
                case ITakeAnySection _:
                    {
                        return new TakeAnyMapLocationControlVM(mapLocation, mapArea, pinnedLocations);
                    }
                ...
                default:
                    {
                        return new MapLocationControlVM(mapLocation, mapArea, pinnedLocations);
                    }
            };
        }
    }
