...
namespace OpenTracker.ViewModels.MapAreaControls
{
    ...
    /// </summary>
    public class MarkableMapLocationControlVM : MapLocationControlVMBase, IClickHandler,
        IDoubleClickHandler, IPointerOver
    {
        ...
        /// </param>
        public MarkableMapLocationControlVM(
            MapLocation mapLocation, MapAreaControlVM mapArea,
            ObservableCollection<PinnedLocationControlVM> pinnedLocations,
            MarkingMapLocationControlVM marking, Dock entranceMarkingDock, Dock nonEntranceMarkingDock)
        {
