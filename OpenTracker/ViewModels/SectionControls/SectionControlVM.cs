...
namespace OpenTracker.ViewModels.SectionControls
{
    ...
    public class SectionControlVM : ViewModelBase
    {
        ...
        public ObservableCollection<SectionIconControlVMBase> Icons { get; }
        ...
        /// </param>
        public SectionControlVM(
            ISection section, ObservableCollection<SectionIconControlVMBase> icons)
        {
