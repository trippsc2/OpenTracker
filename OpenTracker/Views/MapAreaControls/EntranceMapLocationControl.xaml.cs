...
{
    public class EntranceMapLocationControl : UserControl
    {
        ...
        public EntranceMapLocationControl()
        {
        ...
        {
            if (e.Data.Get(DataFormats.Text) is EntranceMapLocationControl mapEntrance &&
                mapEntrance != this)
            {
