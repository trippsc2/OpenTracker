...
{
    private readonly AlwaysDisplayDungeonItemsRequirement.Factory _factory;
    ...
    /// </param>
    public AlwaysDisplayDungeonItemsRequirementDictionary(AlwaysDisplayDungeonItemsRequirement.Factory factory)
