...
public sealed class SectionAutoTrackingFactory : ISectionAutoTrackingFactory
{
    ...
    private readonly RaceIllegalTrackingRequirement _raceIllegalTrackingRequirement;
    ...
    ///     The <see cref="RaceIllegalTrackingRequirement"/>.
    /// </param>
    ...
    public SectionAutoTrackingFactory(
        ...
        RaceIllegalTrackingRequirement raceIllegalTrackingRequirement,
